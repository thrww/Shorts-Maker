...
json_file = f"{project_dir}/sources/verses_data/peace_data.json"
...
fonts_paths = [f'{project_dir}/sources/fonts/AdventureScript.ttf', f'{project_dir}/sources/fonts/BusterDown.ttf', f'{project_dir}/sources/fonts/CoffeeJellyUmai.ttf']
